...
import br.com.anteros.mqttv5.client.MqttActionListener;
import br.com.anteros.mqttv5.client.MqttClientException;
import br.com.anteros.mqttv5.client.MqttClientPersistence;
import br.com.anteros.mqttv5.client.MqttDeliveryToken;
import br.com.anteros.mqttv5.client.MqttPingSender;
import br.com.anteros.mqttv5.client.MqttToken;
...
import br.com.anteros.mqttv5.common.packet.MqttAck;
import br.com.anteros.mqttv5.common.packet.MqttAuth;
import br.com.anteros.mqttv5.common.packet.MqttConnAck;
import br.com.anteros.mqttv5.common.packet.MqttConnect;
import br.com.anteros.mqttv5.common.packet.MqttPingReq;
import br.com.anteros.mqttv5.common.packet.MqttPingResp;
import br.com.anteros.mqttv5.common.packet.MqttProperties;
import br.com.anteros.mqttv5.common.packet.MqttPubAck;
import br.com.anteros.mqttv5.common.packet.MqttPubComp;
import br.com.anteros.mqttv5.common.packet.MqttPubRec;
import br.com.anteros.mqttv5.common.packet.MqttPubRel;
...
public class ClientState implements MqttState {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see br.com.anteros.mqttv5.client.internal.MqttState#send(br.com.anteros.
	 * client.mqttv3.internal.wire.MqttWireMessage,
	 * br.com.anteros.mqttv5.client.MqttToken)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * br.com.anteros.mqttv5.client.internal.MqttState#persistBufferedMessage(org.
	 ...
	 * 
	 * @see
	 * br.com.anteros.mqttv5.client.internal.MqttState#unPersistBufferedMessage(
	 * br.com.anteros.mqttv5.client.internal.wire.MqttWireMessage)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see br.com.anteros.mqttv5.client.internal.MqttState#checkForActivity(org.
	 ...
	 * (non-Javadoc)
	 * 
	 * @see br.com.anteros.mqttv5.client.internal.MqttState#notifySentBytes(int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * br.com.anteros.mqttv5.client.internal.MqttState#notifyReceivedBytes(int)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see br.com.anteros.mqttv5.client.internal.MqttState#connected()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see br.com.anteros.mqttv5.client.internal.MqttState#resolveOldTokens(org.
	 ...
	 * (non-Javadoc)
	 * 
	 * @see br.com.anteros.mqttv5.client.internal.MqttState#quiesce(long)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see br.com.anteros.mqttv5.client.internal.MqttState#notifyQueueLock()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see br.com.anteros.mqttv5.client.internal.MqttState#getActualInFlight()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see br.com.anteros.mqttv5.client.internal.MqttState#getDebug()
	 */
	@Override
