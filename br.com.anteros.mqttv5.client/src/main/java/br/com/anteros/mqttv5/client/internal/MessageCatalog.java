		...
		if (INSTANCE == null) {
			if (ExceptionHelper.isClassAvailable("java.util.ResourceBundle")) {
				try {
					...
					INSTANCE = (MessageCatalog)Class.forName("br.com.anteros.mqttv5.client.internal.ResourceBundleCatalog").newInstance();
				} catch (Exception e) {
					return "";
				}
			} else if (ExceptionHelper.isClassAvailable("br.com.anteros.mqttv5.client.internal.MIDPCatalog")){
				try {
					INSTANCE = (MessageCatalog)Class.forName("br.com.anteros.mqttv5.client.internal.MIDPCatalog").newInstance();
				} catch (Exception e) {
					return "";
				}
			}
