 ...
 * {@link br.com.anteros.mqttv5.client.util.Debug Debug} provides method to make it easy
...
public class JSR47Logger implements Logger {
	 ...
	 * @param loggerID			The suffix for the loggerName (will be appeneded to br.com.anteros.mqttv5.client
...
//		loggerName = "br.com.anteros.mqttv5.client." + ((null == loggerID || 0 == loggerID.length()) ? "internal" : loggerID);
		loggerName = loggerID;
