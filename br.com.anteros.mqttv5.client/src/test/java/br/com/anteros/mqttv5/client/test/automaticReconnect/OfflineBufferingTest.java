package br.com.anteros.mqttv5.client.test.automaticReconnect;
...
import br.com.anteros.mqttv5.client.DisconnectedBufferOptions;
...
public class OfflineBufferingTest {
	...
	public void testBufferedMessageTopicAlias() throws Exception {
		...
		Assert.assertEquals(client.getBufferedMessageCount(), 1);
		MqttMessage publishedMessage = client.getBufferedMessage(0);
