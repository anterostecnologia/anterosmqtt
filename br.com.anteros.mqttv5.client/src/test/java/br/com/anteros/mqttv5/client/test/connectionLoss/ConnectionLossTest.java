 ...
 * with a broker.
 * 
 * >> The tests MUST BE run manually and they WILL FAIL in an automated test
 * environment. << The pom.xml of the test project, all tests categorized as
 * ManualTests are excluded from the execution.
 * 
 * The tests will print a messages in the console notifying the operator when to
 * "unplug" the internet connection of the test machine.
 * 
 * @author mcarrer
 */
...
public class ConnectionLossTest implements MqttCallback {
	...
	/**
	 * Tests whether paho can detect a connection loss with the server even if it
	 * has outbound activity by publishing messages with QoS 0.
	 * 
	 * @throws Exception
	 */
	@Test
	...
	/**
	 * Tests whether paho can detect a connection loss with the server even if it
	 * has outbound activity by publishing messages with QoS 1.
	 * 
	 * @throws Exception
	 */
	@Test
	...
	/**
	 * Tests whether paho can detect a connection loss with the server even if it
	 * has outbound activity by publishing messages with QoS 2.
	 * 
	 * @throws Exception
	 */
	@Test
	...
	/**
	 * Tests whether async paho can detect a connection loss with the server even if
	 * it has outbound activity by publishing messages with QoS 1.
	 * 
	 * @throws Exception
	 */
	@Test
	...
	/**
	 * Tests whether paho keeps the connection alive for 10 keep alive intervals
	 * while publishing messages with QoS 0.
	 * 
	 * @throws Exception
	 */
	@Test
	...
	/**
	 * Tests whether paho keeps the connection alive for 10 keep alive in idle
	 * state.
	 * 
	 * @throws Exception
	 */
