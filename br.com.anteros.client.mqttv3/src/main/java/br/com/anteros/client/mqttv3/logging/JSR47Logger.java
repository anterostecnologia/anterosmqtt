 ...
 * {@link br.com.anteros.client.mqttv3.util.Debug Debug} provides method to make it easy
...
public class JSR47Logger implements Logger {
	 ...
	 * @param loggerID			The suffix for the loggerName (will be appeneded to br.com.anteros.client.mqttv3
...
//		loggerName = "br.com.anteros.client.mqttv3." + ((null == loggerID || 0 == loggerID.length()) ? "internal" : loggerID);
		loggerName = loggerID;
